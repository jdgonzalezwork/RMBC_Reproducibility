...
library(RMBC)
library(parallel)
source("utils/dataGeneratingProcess2_clean.R")
...
nom=paste("simulationResults2021_CLEAN_n_rep_", nrep,"_partial.RDATA",sep="")
save.image(nom)


######## SCRIPT TO BUILD THE TABLE #####
#test.file 
#load("RData/simulationResults2021_CLEAN_n_rep_500_partial.RDATA")
