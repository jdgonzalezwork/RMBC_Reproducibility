...
dataGeneratingProcess=function(sem,case){
  ...
  if (case=="SunSpot5"){
    ...
    #### BALANCED #############
    ReportedActualAlpha=rep(1,actualk)/actualk # checked
    
    actualAlpha=(1-alphaCont)*ReportedActualAlpha
    a=c(30,40)# checked
    b=c(30,40)# checked
    p=2; # checked
  #old  numberofparameters_per_cluster= nroPorEstimador*(1+p+p*(p+1)/2)
    numberofparameters_per_cluster= 50
    n=actualk*numberofparameters_per_cluster;
...
#    n=1000;
    ...
    #numberofparameters_per_cluster= actualk*(1+p+p*(p+1)/2)
    #n=nroPorEstimador*numberofparameters_per_cluster;
    numberofparameters_per_cluster= 50
    n=actualk*numberofparameters_per_cluster;
...
#    n=1000;     
    ...
    #numberofparameters_per_cluster=nroPorEstimador*(1+p+p*(p+1)/2)
    #n= actualk*numberofparameters_per_cluster;
    numberofparameters_per_cluster= 50
    n=actualk*numberofparameters_per_cluster;
  ...
  if (case=="SideNoise2H"){ 
    ...
    pp=20; #In this case, the parameter p refers only to the first  two coordinates.
    #numberofparameters_per_cluster= actualk*(1+pp+pp*(pp+1)/2)
    #n=nroPorEstimador*numberofparameters_per_cluster;
...
#    ReportedActualAlpha=c(1/11, 2/11, 2/11, 2/11, 2/11, 2/11)
  ...
  if (case=="RandomScatterH"){ #CHECKED
    ...
    #old numberofparameters_per_cluster= actualk*(1+p+p*(p+1)/2)
    #old n=nroPorEstimador*numberofparameters_per_cluster;
    numberofparameters_per_cluster= 50
    n=actualk*numberofparameters_per_cluster;
